...
ffmpeg -framerate 1 -i frames/frame%03d.png -c:v libvpx-vp9 -pix_fmt yuva420p -vf scale=720:-1 -lossless 1 output/creepFast.webm
ffmpeg -framerate 0.4 -i frames/frame%03d.png -c:v libvpx-vp9 -pix_fmt yuva420p -vf scale=720:-1 -lossless 1 output/creepSlow.webm
